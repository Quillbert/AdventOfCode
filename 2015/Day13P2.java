...
public class Day13P2 {
	...
	public static void main(String[] args) {
		...
		ArrayList<Person> unused = new ArrayList<Person>(tempPeople.values());
		
		Person you = new Person("you");
		
		for(Person person : unused) {
			you.happiness.put(person.name, 0);
			person.happiness.put("you", 0);
		}
		
		unused.add(you);
		
		System.out.println(best(new ArrayList<Person>(), unused));
	}
